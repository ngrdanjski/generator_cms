    ...
    >
      ...
      >
        ...
        <div class="menu-item">
          ...
          <a
            class="menu-link"
            href="https://preview.keenthemes.com/Generator8/vue/docs/#/utilities"
          >
        ...
        <div class="menu-item">
          ...
          <a
            class="menu-link"
            href="https://preview.keenthemes.com/Generator8/vue/docs/#/doc-overview"
          >
            <span class="menu-icon">
        ...
        <div class="menu-item">
          ...
          <a
            class="menu-link"
            href="https://preview.keenthemes.com/Generator8/vue/docs/#/changelog"
          >
            <span class="menu-icon">
              <i
                v-if="sidebarMenuIcons === 'font'"
