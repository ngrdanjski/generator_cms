          ...
          <div class="mb-0">
            ...
            <div class="mb-7">
              <div class="d-flex flex-stack">
                <h3 class="mb-0">Generator Licenses</h3>
            ...
            <!--begin::Purchase-->
            <a
              href="https://themeforest.net/item/Generator-responsive-admin-dashboard-template/4021469"
                  ...
                  <div class="col-6">
                    ...
                    >
                      ...
                      <div class="overlay-layer bg-dark bg-opacity-10">
                        <a
                          v-if="item.available"
                          :href="`https://preview.keenthemes.com/Generator8/vue/${item.name}`"
