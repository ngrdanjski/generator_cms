        ...
        <div class="d-flex flex-stack">
          ...
          <div class="badge badge-lg badge-light-primary">
            <div class="d-flex align-items-center flex-wrap">
              ...
              <!--end::Svg Icon-->
              <a
                href="/Generator8/demo1/../demo1/apps/file-manager/folders.html"
                >Uploads</a
              >
                ...
                <tr class="odd" v-for="(file, key) in files" :key="key">
                  ...
                  >
                    <div class="d-flex justify-content-end">
                      ...
                      <!--                        >-->
                      <!--                          &lt;!&ndash;begin::Svg Icon | path: icons/duotune/coding/cod007.svg&ndash;&gt;-->
                      ...
                      <!--                                  &lt;!&ndash;begin::Svg Icon | path: icons/duotune/arrows/arr085.svg&ndash;&gt;-->
                      <!--                                  <span-->
      ...
      <div class="modal-dialog modal-dialog-centered modal-md">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button @click="updateFile(this.selectedFile)">Update</button>
          </div>
        </div>
      </div>
    </div>
...
export default defineComponent({
  ...
  mounted() {
    ApiService.get("/media").then(({ data }) => {
